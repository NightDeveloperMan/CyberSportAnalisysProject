...
import ru.csap.cibersportanalisysproject.game.attributes.csmodules.Team;
...
public class MapParse {
    ...
    public MapParse(Team team, String mapName) throws IOException, SQLException, InterruptedException {
        this.team = team;
        this.mapName = mapName;
        ConnectionServise connectionServise = new ConnectionServise();
        ...
        Elements parseElements = connectionServise.connection(url + "stats/teams/"
                ...
                + "&maps="
                + mapName).getElementsByClass("large-strong"); /// ПРОБЛЕМА НЕ РЕШЕНА!!!!
